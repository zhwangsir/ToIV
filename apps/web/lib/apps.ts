...
/**
 * 场景分组(2026-09-14 分类重设计):12 个 use_case 枚举收敛为 8 个用户视角的
...
/** 场景组 id → 组定义;未知返回 null。 */
export function useCaseGroup(id: string): (typeof USE_CASE_GROUPS)[number] | null {
  return USE_CASE_GROUPS.find((g) => g.id === id) ?? null;
}
