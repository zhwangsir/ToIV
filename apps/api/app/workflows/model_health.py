...
def _suggest_fallbacks(missing: list[str]) -> list[str]:
    ...
    fallback_map = {
        ...
        "majicMIX realistic 麦橘写实_v7.safetensors": "替代方案: cyberrealistic_v120 或 ponyRealism_V22",
        "waiIllustriousSDXL_v170.safetensors": "替代方案: hassakuXLIllustrious_v34 或 animagineXL40",
