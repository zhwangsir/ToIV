...
def ltx_txt2video():
    ...
    n2 = node(2, "LTXVGemmaCLIPModelLoader", (30, 150), (380, 100), outputs=[output("CLIP", "CLIP")], widgets=["gemma3_12b_it_bf16/model.safetensors", "10eros_v14.safetensors", 1024], order=1)
...
def ltx_lipsync():
    ...
    n12 = node(12, "LTXVAudioVAELoader", (450, 750), (340, 80), outputs=[output("AUDIO_VAE", "AUDIO_VAE")], widgets=["ltx-2.3-22b-distilled-1.1.safetensors"], order=7)
