...
创作页引擎 2026-08-27 已追上现役注册表（`f261f45`）：含 qwen-image-edit、h3-multishot、wan-transition、keyframe-chain、vace-edit、wan-animate-2、wan-nsfw-i2v；已去掉 ltx25-*。作品库分桶已按 Job.kind 对齐远程 main 25cdc6a。仍归其他：bucketed on 25cdc6a; engine ids wan-animate wan-animate-2 still other。
