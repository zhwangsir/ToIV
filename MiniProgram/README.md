...
创作页引擎 2026-08-27 已追上现役注册表（`f261f45`）：含 qwen-image-edit、h3-multishot、wan-transition、keyframe-chain、vace-edit、wan-animate-2、wan-nsfw-i2v；已去掉 ltx25-*。作品库分桶已按 Job.kind 对齐远程 main a95e174。仍归其他：chromakey / i2l / motion_brush / wan_animate / wan_animate2。
