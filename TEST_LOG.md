...
- 2026-09-10 LIVE：H3:8195 T8/blockcache/KJNodes/vrgamedevgirl 装齐（设备管家；docs）：仅 h3-eval，未进通用池；`T8mars/comfyui-minimax-h3-audio-T8` @ e4ff860（DualClock/AVDecode/AudioConditioning T8=Y）；blockcache-T8 @ 36336dce + KJNodes @ 57105374 + vrgamedevgirl @ c85fda6d；目标 class_type 全 Y；T8/Sage/VRGDG 节点齐；侧扫旁证由能力缺口再跑——勿宣称 side-scan/capability_gap rescan；status=`live_device_fyi`；STATE `h3_8195_t8_nodes_2026_09_10`；updated_at 2026-09-10T04:16:30+08:00；AGENTS §七 已短注。
