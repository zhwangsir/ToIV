...
- 2026-09-08 LIVE：FE≥1.49.6 部分完成 + 去重/封面执行结果（真机/docs）：生图池 FE WS/pc02=**1.52.7** pc01=**1.49.6**（→1.52.7 进行中）；H3 未动；~~1.45.x~~ SUPERSEDED for gen-pool FE；去重 85组 kept85 soft-hide**243** del0 市场2163→**1920** rh-acc949→**706** 日志 `.regen_tmp/dedupe-hash-20260908.json`；渐变假封面 UX **114→0** 日志 `.regen_tmp/gradient-cover-fix-20260908.json`；status=`fe_partial_dedupe_covers_done`；STATE `rh_comfy_covers_dupes_audit_2026_09_08`；updated_at 2026-09-08T02:16:00+08:00；无产品 SHA；AGENTS §七 已短注；未推。
