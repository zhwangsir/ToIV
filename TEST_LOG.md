...
- 2026-09-10 mass soft-hide unusable v20 ×388（项目管家；ToIV 开发 tip；docs；无产品 SHA）：用户拍板只留能用；清单 hide **398**/新藏~**388**；生产 soft-hide **388** → is_public=false；公开约 **896→508**（期望 510；API list_len 510，含 2 张非公开 keep）；keep=main_ok∪ok_if_dedicated_h3=**510**；真源 `.regen_tmp/capability_gap_scan_v20/actionable/soft_hide_all_non_usable_v20.json` + `soft_hide_all_unusable_v20.json`/`_applied.json` **勿 stage**（已 applied）；不列 388 ids；产品 dirty 勿提交；未写 h3/；无 MODEL_SOURCES 变更；不扫 v21；status=`soft_hide_docs`；STATE `soft_hide_all_unusable_v20_2026_09_10`；updated_at 2026-09-10T14:20:00+08:00；AGENTS §七 已短注。
