...
- 2026-09-06 设备管家 beijing 真机只读登入回写：8.140.222.24 hostname `iZ2ze325an97cwlbt1wxfdZ`；Ubuntu 24.04.4 LTS；1.6Gi RAM 无 swap；40G 盘约用 15%；角色确认 CN 入口 toiv.wineryz.top（OpenResty+ACME）；Docker `1Panel-openresty` + `1Panel-frps`（frps 0.68.1）听 7000/7500/13100/18090，另有 `1panel-core` :1722；SSH root 密码可登、MateBook 默认 id_ed25519 公钥不行、~/.ssh/config 尚无 beijing Host；未改服务；密码不入文档；Tailscale 仍 —。
