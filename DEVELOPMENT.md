...
**2026-09-10 MODEL_SOURCES：ok412/blocked375/total787（ToIV 模型下载；RMBG-2.0）**：RMBG-2.0 落入后计数对齐；header 已同步 JSON `updated_at` 2026-09-10T03:13:45+08:00。status=`inventory_updated`；STATE `model_sources_rmbg20_2026_09_10`；updated_at 2026-09-10T03:14:00+08:00。
